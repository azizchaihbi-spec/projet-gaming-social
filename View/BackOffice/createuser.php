...
<head>
    ...
    <title>Play2Help • Créer Utilisateur</title>
...
<body class="relative min-h-screen overflow-x-hidden">
    ...
    <nav class="bg-gray-900/80 backdrop-blur-lg border-b border-cyan-500/30 py-4 px-6">
        <div class="container mx-auto flex justify-between items-center">
            <div class="flex items-center space-x-4">
                ...
                <span class="text-gray-300">Créer Utilisateur</span>
            </div>
    ...
    <main class="container mx-auto px-6 py-8 max-w-4xl">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold font-orbitron neon">NOUVEL UTILISATEUR</h1>
            <p class="text-cyan-400 text-lg mt-2">Ajouter un utilisateur à la plateforme</p>
        </div>
        ...
        <div class="card rounded-3xl p-8 glow">
            <form action="index.php?action=create" method="POST" class="space-y-6">
                ...
                <div id="streamer-fields" class="space-y-6 hidden">
                    ...
                    <div>
                        ...
                        <textarea name="stream_description" rows="3" 
                                  class="w-full bg-gray-800 border border-cyan-500/30 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-cyan-400"></textarea>
                    </div>
