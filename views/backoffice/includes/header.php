...
<nav class="bg-gray-900/80 backdrop-blur-lg border-b border-cyan-500/30 py-4 px-6">
    <div class="container mx-auto flex justify-between items-center">
        <div class="flex items-center space-x-4">
            ...
            <a href="index.php" class="px-4 py-2 rounded-lg font-semibold bg-cyan-700 hover:bg-cyan-600 text-white transition">Gestion Utilisateurs</a>
            <a href="admin.php" class="px-4 py-2 rounded-lg font-semibold bg-purple-700 hover:bg-purple-600 text-white transition">Gestion Forum</a>
        </div>
